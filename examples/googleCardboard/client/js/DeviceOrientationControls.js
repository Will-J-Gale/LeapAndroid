  ...
  this.update = (function(delta) {
    ...
    return function(delta) {
      ...
      this.object.quaternion.multiply(this.orientationQuaternion);
        ...
        var tempx = THREE.Math.radToDeg(this.object.rotation.x);
        var tempy = THREE.Math.radToDeg(this.object.rotation.y);
        var tempz = THREE.Math.radToDeg(this.object.rotation.z);
        var tempData = {
          x:tempx, 
          y:tempy, 
          z:tempz
